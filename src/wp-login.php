...
function login_header( $title = null, $message = '', $wp_error = null ) {
	...
	$login_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; MosaicPress' ), $title, $login_title );
	...
	$login_header_text = empty( $login_header_title ) ? __( 'Powered by MosaicPress' ) : $login_header_title;
