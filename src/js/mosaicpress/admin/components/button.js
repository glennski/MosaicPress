 ...
 * Tailgrids button.
 *
 * From https://github.com/TailGrids/tailgrids (MIT),
 * apps/docs/src/registry/core/button.tsx
 */
...
export const buttonStyles = cva(
	'flex items-center justify-center gap-3 rounded-lg font-medium transition focus:ring-3 disabled:pointer-events-none [&>svg]:text-current outline-none',
	{
		...
		compoundVariants: [
			...
			{ iconOnly: true, size: 'sm', className: 'size-10' },
			{ iconOnly: false, size: [ 'xs', 'sm' ], className: 'px-3.5' },
			{ iconOnly: true, size: 'md', className: 'size-11' },
			{ iconOnly: false, size: 'md', className: 'px-4' },
			{ iconOnly: true, size: 'lg', className: 'size-12' },
			{ iconOnly: false, size: 'lg', className: 'px-5' },
			{ iconOnly: false, className: 'py-2.5' },
		],
		defaultVariants: {
			variant: 'primary',
			appearance: 'fill',
